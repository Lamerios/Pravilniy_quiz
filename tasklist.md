...
| 👥 **2** | Команды (CRUD) | ⏸️ Ожидает | - | Добавление команд с логотипами |
| 🎮 **3** | Создание игр | ⏸️ Ожидает | - | Создание игры с командами |
| ⚡ **4** | Проведение игр | ⏸️ Ожидает | - | Обновление счета в реальном времени |
...
- [ ] GET /api/templates/:id - получение шаблона с раундами
- [ ] PUT /api/templates/:id - редактирование шаблона
- [ ] DELETE /api/templates/:id - удаление шаблона

### 🎨 Frontend UI
- [ ] Страница списка шаблонов (/admin/templates)
- [ ] Форма создания нового шаблона
- [ ] Компонент добавления/редактирования раундов
- [ ] Валидация: название шаблона, название раундов, максимальные баллы
...
- [ ] POST /api/teams/:id/logo - загрузка логотипа
- [ ] GET /api/teams - список команд
- [ ] PUT /api/teams/:id - редактирование команды
- [ ] DELETE /api/teams/:id - удаление команды

### 🎨 Frontend UI
- [ ] Страница управления командами (/admin/teams)
- [ ] Форма создания команды с загрузкой логотипа
- [ ] Компонент отображения списка команд с превью логотипов
- [ ] Inline редактирование названий команд

### 📁 Файловая система
- [ ] Middleware для загрузки файлов (multer)
- [ ] Валидация типов и размеров изображений
- [ ] Endpoint для отдачи статических файлов логотипов
...
- [ ] GET /api/games/:id - получение игры с участниками
- [ ] PUT /api/games/:id/participants - управление участниками

### 🎨 Frontend UI
- [ ] Страница списка игр (/admin/games)
- [ ] Форма создания игры с выбором шаблона
- [ ] Компонент добавления команд-участников
- [ ] Компонент назначения номеров столов
- [ ] Отображение статуса игры (created/active/finished)

### 🔗 Интеграция
- [ ] Получение списка шаблонов для выбора
- [ ] Получение списка команд для добавления в игру
- [ ] Валидация: минимум 2 команды, уникальные номера столов
...
**Проверка:** Создать игру на основе шаблона "Классический квиз" с командами и столами №1-4

---

## ⚡ Итерация 4: Проведение игр

**Цель:** Управление ходом игры и обновление счета в реальном времени  
**Тест:** Провести полную игру с переключением раундов и вводом баллов

### 🗄️ Backend API
- [ ] PUT /api/games/:id/status - старт/финиш игры
- [ ] PUT /api/games/:id/round - переключение раунда
- [ ] POST /api/games/:id/scores - обновление баллов команды
- [ ] GET /api/games/:id/scores - получение всех баллов
...
- [ ] Страница управления игрой (/admin/games/:id)
- [ ] Кнопки управления статусом игры (Старт/Финиш)
- [ ] Переключение между раундами
- [ ] Форма ввода баллов для каждой команды в раунде
- [ ] Отображение текущего счета

### 🧪 Тестирование
- [ ] Тесты Socket.io соединений
- [ ] Тесты обновления счета
- [ ] Интеграционные тесты реального времени

**Проверка:** Запустить игру, переключить на раунд 1, ввести баллы всем командам, переключить на раунд 2
